...
\medskip \noindent \textit{Hint:} \rotatebox[origin=c]{180}{Consider possible uses for certified random numbers.}
...
Download some samples and circuits from the data repository for Ref.~\citenum{arute2019quantum} at \url{https://datadryad.org/stash/dataset/doi:10.5061/dryad.k6t1rj8}.
