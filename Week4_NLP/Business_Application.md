...
## Business proposal: Sens.ei - Your Emotionally Aware Virtual Assistant
...
**Products/roadmap:** we build expertise first in QNLP-text sentiment algorithm and then extend our products to QNLP-speech to text and - text to speech algorithms.
