...
**Products/roadmap:** with our first generation virtual assistant Eva, we build expertise first in QNLP-text sentiment algorithm and then extend our products to QNLP-speech to text and - text to speech algorithms.
